...
1. Klónozd a repót:  
   ```sh
   git clone https://github.com/Felhasznalo/PassLibrary.git
## Futtatás
...
7. Futtasd le ezt a kódot és ha kész akkor nincs más dolgod mint beírni: https://localhost/LearnUp vagy localhost:80/LearnUp
